        ...
        <>
            <Row>
                ...
                <Col sm={9} md={8} xl={9}>
                    ...
                    <input
                        className="movie-name-input mb-3"
                    ...
                    <div className="d-flex justify-content-between align-items-start">
                        <h4>Genres</h4>
                        <Button className= "border border-2 border-dark rounded-2"  variant="outline-dark" size="sm" onClick={() => openForm("genres")}>
                            Add genre
                        </Button>
                    </div>
                    <ItemsSelect
                    ...
                    <div className="d-flex justify-content-between align-items-start mt-4">
                        <h3>Directors</h3>
                        <Button className= "border border-2 border-dark rounded-2" variant="outline-dark" size="sm" onClick={() => openForm("directors")}>
                            Add Director
                        </Button>
                    </div>
                    <ItemsSelect
                    ...
                    <div className="d-flex justify-content-between align-items-start mt-4">
                        <h3>Actors</h3>
                        <Button className= "border border-2 border-dark rounded-2" variant="outline-dark" size="sm" onClick={() => openForm("actors")}>
                            Add actor
                        </Button>
                    </div>
                    <ItemsSelect
            ...
            <div 
             className= "border border-2 border-dark rounded-2 options-movie-buttons">
                <Button
                    variant="dark"
                    size='lg'
                    onClick={saveMovie}
